        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="inline-flex rounded-xl border border-stroke bg-white p-4">
                <ul className="-mx-[6px] flex items-center">
                  <li className="px-[6px]">
                    <a
                      href=""
                      className="flex h-9 w-9 items-center justify-center rounded-md border border-stroke bg-transparent text-base text-body-color hover:border-primary hover:bg-primary hover:text-white"
                    >
                      <span>
                        <svg
                          width={8}
