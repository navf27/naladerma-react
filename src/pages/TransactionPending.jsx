...
const TransactionPending = () => {
  ...
  return (
    <>
      ...
      <Navbar />
      <div
        className={`container mb-14 lg:mb-96 mt-3 lg:mt-16 border border-red flex justify-center`}
      >
        <div className="flex flex-col lg:flex-row lg:flex-wrap lg:gap-6 lg:justify-start lg:items-start gap-3 border border-blue w-[1204px]">
          {loading &&
            count.map((data, index) => {
              return (
                <div
                  className="bg-[#FFFEFB] shadow-1 rounded-md p-5 lg:w-96 lg:h-fit"
                  key={index}
                >
                  ...
                  <div>
                    ...
                    {loading ? (
                      ...
                      <p
                        ...
                        className="text-xs bg-[#FFF5EB] text-[#FEA70C] w-fit py-1 px-2 mt-1 rounded-lg"
                      >
                        Pembayaran Tertunda
                      </p>
                    )}
