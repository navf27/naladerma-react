...
//     (item) =>
//       // Filter data berdasarkan nilai pencarian (jika ada)
...
//     setPageNumber(0); // Kembali ke halaman pertama setelah perubahan pencarian
//   };
...
//         <div className="w-screen p-4" ref={domNode}>
...
//               </div>
//             </div>
//             <div className="self-center w-full absolute z-30 flex justify-end items-center gap-4 top-3">
//               <div className="">
//                 <input
//                   id="searchInput"
//                   value={searchTerm}
...
//           {dataFetched ? (
//             <>
//               <Table th={thData} tableData={currentPageData}></Table>
//             </>
//           ) : (
//             <>
