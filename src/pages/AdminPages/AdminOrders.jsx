                ...
                {Array.isArray(currentPageData)
                  ? currentPageData?.map((item, index) => (
                      <tr key={index}>
                        ...
                        <td className={TdStyle.TdStyle2}>{item.event?.name}</td>
                        <td className={TdStyle.TdStyle}>{item.quantity}</td>
                        <td className={TdStyle.TdStyle2}>Rp. {item.total}</td>
                        <td className={`${TdStyle.TdStyle}`}>
                            ...
                            <div
                              className={`${
                                item.status === "paid"
                                  ...
                                  : "bg-[#FFF5EB] text-[#FEA70C] py-1 px-3 rounded-full"
                        ...
                        <td className={TdStyle.TdStyle2}>{item.date}</td>
                      </tr>
                    ))
                  : null}
              </Table>
...
export default AdminOnlyRoute(AdminOrders);
