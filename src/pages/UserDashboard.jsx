  ...
  return (
    <>
      ...
      <AdminDashboardTemplate>
        <div className="lg:ms-60 p-4 h-screen">
          <div className="lg:pt-7 pt-16 flex justify-center lg:items-center h-full">
            <div className="bg-[#FFFEFB] w-72 pb-12 drop-shadow-md rounded-lg relative h-fit">
              <div className="bg-[#FFD970] h-32 rounded-lg">
                <div className="flex justify-end">
                  <button onClick={() => setModalOpened(true)} className="p-3">
                    <svg
                ...
                <div className="mt-5 flex flex-col items-center gap-1">
                  {userData ? (
                    ...
                    <p className="text-sm text-dark-4 flex justify-center gap-2 bg-gray-300 rounded-full animate-pulse w-fit">
                      ...
                      <span className="invisible">bronaufalaji@gmail.com</span>
                    </p>
                  )}
