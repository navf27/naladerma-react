...
const SignIn = () => {
  ...
  return (
    <div className="flex justify-center items-center h-dvh">
      ...
      <div className="bg-[#FFFEFB] shadow-lg rounded-lg w-80 p-7 py-9 lg:absolute lg:w-2/3 lg:h-4/5 lg:flex lg:flex-row-reverse lg:items-center lg:justify-between lg:p-0">
        {loading ? (
        ...
        <div className="hidden lg:block lg:border lg:border-red-500 lg:w-96 lg:h-full">
          INI GAMBAR
        </div>
        <div className="lg:flex lg:justify-center lg:ps-14">
